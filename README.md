...
- **master**: This branch is reserved exclusively for final pull requests and production-ready code. It represents the stable version of the project.
- **feature**: All development work, updates, and experimental changes are performed in the feature branch. Once the features are tested and verified, they are merged into the master branch via pull requests.
